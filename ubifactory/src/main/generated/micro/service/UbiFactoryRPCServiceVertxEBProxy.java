...
public class UbiFactoryRPCServiceVertxEBProxy implements UbiFactoryRPCService {
  ...
  public UbiFactoryRPCServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public UbiFactoryRPCServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void addUbiSOM(JsonObject o, Handler<AsyncResult<JsonObject>> handler) {
    ...
    _json.put("o", o);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "addUbiSOM");
  ...
  public void getUbiSOM(String id, Handler<AsyncResult<JsonObject>> handler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getUbiSOM");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void deleteUbiSOM(String id, Handler<AsyncResult<Boolean>> handler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteUbiSOM");
  ...
  public void undeployUbiSOM(String id, Handler<AsyncResult<Boolean>> handler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "undeployUbiSOM");
    _vertx.eventBus().<Boolean>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void feedUbiSOM(JsonObject o, Handler<AsyncResult<Boolean>> handler) {
    ...
    _json.put("o", o);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "feedUbiSOM");
    _vertx.eventBus().<Boolean>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void getUbiSOMData(String id, Handler<AsyncResult<JsonObject>> handler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getUbiSOMData");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void getHitCount(String id, Handler<AsyncResult<JsonArray>> handler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getHitCount");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void getUMat(String id, Handler<AsyncResult<JsonArray>> handler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getUMat");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public void getWeights(String id, Handler<AsyncResult<JsonArray>> handler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getWeights");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
